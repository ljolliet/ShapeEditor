...
public class Toolbar {
    ...
    public Toolbar() {
        ...
        addShape(group2);
        addShape(new Rectangle(100, 50, 0,  new Point2D(0,0), new Color(55,255,55, 1.), new Point2D(50,25), 0));
        addShape(new Polygon(6, 50,  new Point2D(0,0), new Color(255,55,55, 1.), new Point2D(0,0), 90));
    }
